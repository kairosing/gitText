        ...
        <div id="panel-1" class="panel">
            ...
            $people = [
                ...
                [
                    ...
                    'email_link_text' => 'Contact Sunny',
                    'email_link_title' => '<i class="fal fa-envelope"></i>',
                    'status' => 'active',
                ...
                [
                    ...
                    'email_link_text' => 'Contact Jovanni',
                    'email_link_title' => '<i class="fal fa-envelope"></i>',
                    'status' => 'banned',
                ],
                [
                    ...
                    'email_link_text' => 'Contact Roberto',
                    'email_link_title' => '<i class="fal fa-envelope"></i>',
                    'status' => 'banned',
                ]
                    ...
                    <div class="d-flex flex-wrap demo demo-h-spacing mt-3 mb-3">
                        ...
                        <div class="<?php echo $person['status'] == 'banned' ? 'banned' : ''; ?> rounded-pill bg-white shadow-sm p-2 border-faded mr-3 d-flex flex-row align-items-center justify-content-center flex-shrink-0">
                            ...
                            <div class="ml-2 mr-3">
                                ...
                                <a href="<?php echo $person['email_link_href'];?>" class="text-info fs-sm" target="_blank" title="<?php echo $person['email_link_text'];?>"><?php echo $person['email_link_title'];?></a>
                            </div>
                        </div>
