...
<!--                            <p>-->
<!--                                We collect certain data through cookies and similar technologies-->
<!--                                (e.g. web beacons, tags, device identifiers). Cookies are text files placed-->
<!--                                on your computer to collect standard internet log information and visitor behaviour-->
<!--                                information. This information is used to track visitor use of the website and to-->
<!--                                compile statistical reports on website activity. We register your interaction with our-->
<!--                                services in order to improve our website, content and services. Our use of such-->
<!--                                technologies and the data collected is described in more detail in our Cookie Policy.-->
...
<!--                            </p>-->
                                ...
                                $items = [
                                    ...
                                    [
                                        ...
                                        "description" => "We collect certain data through cookies and similar technologies 
                                             (e.g. web beacons, tags, device identifiers). Cookies are text files placed
                                             on your computer to collect standard internet log information and visitor behaviour 
                                             information. This information is used to track visitor use of the website and to
                                             compile statistical reports on website activity. We register your interaction with our 
